...
const FAIL_CLOSED_SCENARIO: &[u8] =
    include_bytes!("../dev-docs/tmux-scenarios/issue687/namespace-override-fail-closed.json");
...
#[test]
fn namespace_override_fail_closed_scenario_is_structurally_valid() {
    ...
    assert_eq!(scenario.name, "issue687-namespace-override-fail-closed");
}
