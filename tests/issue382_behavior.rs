...
use issue382::remote_plan_golden::{
    assert_llxprt_remote_golden, assert_remote_unsupported, assert_serializer_contract,
    find_shipped, golden_remote_identity, probe_compatible,
};
...
use jefe::domain::agent_definition::{
    ...
    ExecutableCandidate, Operation, OperationMatrix, Preflight, ProbeErrorCode, ProbeSpec, Target,
};
