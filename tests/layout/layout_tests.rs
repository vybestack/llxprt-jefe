...
fn issues_pane_rows_account_for_dynamic_bands() {
    ...
    assert_eq!(issues_pane_rows(40, false, true), (9, 23));
    assert_eq!(issues_pane_rows(40, true, true), (9, 22));
}
...
fn issues_detail_viewport_rows_account_for_dynamic_bands() {
    ...
    assert_eq!(issues_detail_viewport_rows(40, false, true), 16);
    assert_eq!(issues_detail_viewport_rows(40, true, true), 15);
}
