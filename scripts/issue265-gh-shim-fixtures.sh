...
# Source: src/github/issue_query.rs build_issue_search_args_sorted.
...
# The exact search query string for the default newest-first open filter.
readonly SEARCH_QUERY_STRING='repo:owner/repo-265 is:issue state:open sort:updated-desc'

# The exact --json field list for `gh issue view`.
# Source: src/github/mod.rs get_issue_detail.
readonly ISSUE_VIEW_JSON_FIELDS='number,title,state,stateReason,author,createdAt,updatedAt,labels,assignees,milestone,body,url,comments,id'
