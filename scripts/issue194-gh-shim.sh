...
case "$*" in
  "api repos/owner/actions-fixture/actions/runs"\?"page=1&per_page=30")
    ...
    cat <<'JSON'
{"total_count":60,"workflow_runs":[{"id":20801,"name":"CI","display_title":"Oldest Actions fixture run","head_branch":"issue208-old","head_sha":"old208","run_number":101,"event":"push","status":"completed","conclusion":"success","created_at":"2026-07-01T00:00:00Z","updated_at":"2026-07-01T00:01:00Z"},{"id":19401,"name":"CI","display_title":"Inspectable Actions fixture","head_branch":"issue194","head_sha":"abc194","run_number":194,"event":"push","status":"completed","conclusion":"failure","created_at":"2026-07-14T00:00:00Z","updated_at":"2026-07-14T00:01:00Z"}]}
JSON
    ;;
...
JSON
    ;;
  "run view --repo owner/actions-fixture 20801 --json attempt,conclusion,createdAt,databaseId,displayTitle,event,headBranch,headSha,name,number,startedAt,status,updatedAt,url,workflowDatabaseId,workflowName")
    cat <<'JSON'
{"databaseId":20801,"name":"Oldest Actions fixture run","headBranch":"issue208-old","headSha":"old208","number":101,"event":"push","status":"completed","conclusion":"success","workflowName":"CI","createdAt":"2026-07-01T00:00:00Z","updatedAt":"2026-07-01T00:01:00Z"}
JSON
    ;;
  "run view --repo owner/actions-fixture 20801 --json jobs --jq .jobs")
    cat <<'JSON'
[]
JSON
    ;;
