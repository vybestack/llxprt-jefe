...
fn create_acp_socket_agent(base_dir: &str) -> Agent {
    ...
    Agent {
        ...
        purpose: "Fix ACP socket timeout".to_owned(),
        work_dir: format!("{}/branch-1/llxprt-code", base_dir.replace("/llxprt-code", "")),
...
fn create_refactor_prompt_agent(base_dir: &str) -> Agent {
    ...
    Agent {
        ...
        purpose: "Refactor prompt handler".to_owned(),
        work_dir: format!("{}/branch-2/llxprt-code", base_dir.replace("/llxprt-code", "")),
...
fn create_retry_429_agent(base_dir: &str) -> Agent {
    ...
    Agent {
        ...
        purpose: "Add retry on 429".to_owned(),
        work_dir: format!("{}/branch-3/llxprt-code", base_dir.replace("/llxprt-code", "")),
        model: "claude-opus-4-6".to_owned(),
        profile: "default".to_owned(),
        mode: "--yolo".to_owned(),
...
fn create_tls_renegotiation_agent(base_dir: &str) -> Agent {
    ...
    Agent {
        ...
        purpose: "TLS renegotiation fix".to_owned(),
        work_dir: format!("{}/branch-1/starflight-tls", base_dir.replace("/starflight-tls", "")),
        model: "claude-sonnet-4-5".to_owned(),
...
fn create_cert_rotation_agent(base_dir: &str) -> Agent {
    ...
    Agent {
        ...
        purpose: "Cert rotation handler".to_owned(),
        work_dir: format!("{}/branch-2/starflight-tls", base_dir.replace("/starflight-tls", "")),
        model: "claude-opus-4-6".to_owned(),
        profile: "go-expert".to_owned(),
        mode: "--yolo".to_owned(),
        status: AgentStatus::Completed,
...
fn create_api_migration_agent(base_dir: &str) -> Agent {
    ...
    Agent {
        ...
        purpose: "API migration v3".to_owned(),
        work_dir: format!("{}/branch-1/gable-work", base_dir.replace("/gable-work", "")),
        model: "claude-opus-4-6".to_owned(),
        profile: "default".to_owned(),
        mode: "--auto-approve".to_owned(),
        status: AgentStatus::Running,
