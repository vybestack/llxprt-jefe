...
impl AgentFormFocus {
    ...
    pub fn next(self) -> Self {
        match self {
            ...
            Self::Profile => Self::CodePuppyModel,
            Self::CodePuppyModel => Self::CodePuppyYolo,
            Self::CodePuppyYolo => Self::AgentKind,
            Self::AgentKind => Self::Mode,
    ...
    pub fn prev(self) -> Self {
        match self {
            ...
            Self::CodePuppyModel => Self::Profile,
            Self::CodePuppyYolo => Self::CodePuppyModel,
            Self::AgentKind => Self::CodePuppyYolo,
            Self::Mode => Self::AgentKind,
