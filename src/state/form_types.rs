...
impl RepositoryFormFocus {
    ...
    pub fn next(self) -> Self {
        match self {
            ...
            Self::DefaultAgentKind => Self::DefaultCodePuppyVersion,
            Self::DefaultCodePuppyVersion => Self::DefaultLlxprtVersion,
    ...
    pub fn prev(self) -> Self {
        match self {
            ...
            Self::DefaultCodePuppyVersion => Self::DefaultAgentKind,
            Self::DefaultLlxprtVersion => Self::DefaultCodePuppyVersion,
