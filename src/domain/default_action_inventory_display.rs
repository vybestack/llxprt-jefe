...
pub const HELP_DISPLAY_LINES: &[HelpDisplayLine] = &[
    ...
    help(2, 5, &["issues.send-agent"], "Send issue detail to agent"),
    help(
        2,
        6,
        &["prs.list-send-agent"],
    ...
    help(
        ...
        7,
        &["prs.send-agent"],
        "Send pull request detail to agent",
    ),
    help(2, 8, &["prs.resolve"], "Resolve / unresolve review thread"),
    help(
        2,
        9,
...
pub const FOOTER_MODE_GROUPS: &[FooterModeGroup] = &[
    ...
    FooterModeGroup {
        ...
        hints: &[
            ...
            hint(
                "send to agent",
                &["issues.list-send-agent", "issues.send-agent"],
                10,
            ),
    ...
    FooterModeGroup {
        ...
        hints: &[
            ...
            hint(
                "send to agent",
                &["prs.list-send-agent", "prs.send-agent"],
                9,
            ),
    ...
    FooterModeGroup {
        ...
        hints: &[
            ...
            hint("reorder", &["settings.move-up", "settings.move-down"], 5),
            hint("unbind", &["settings.unbind"], 6),
            hint("save", &["settings.save"], 7),
            hint("reset", &["settings.reset"], 8),
            hint("back", &["settings.back"], 9),
            hint("quit", &["core.emergency-exit"], 98),
        ],
    },
];
