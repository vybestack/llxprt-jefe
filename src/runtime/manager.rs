...
//!
//! The `RuntimeManager` trait and `LivenessCheck` metadata are defined in
//! [`manager_trait`](super::manager_trait) and re-exported here. This module
//! holds the concrete `TmuxRuntimeManager`.
//!
...
pub use super::manager_trait::{LivenessCheck, RuntimeManager};
