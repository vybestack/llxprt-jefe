...
message_names!(PullRequestsMessage {
    ...
    Self::ChangesLoaded { .. } => "PrChangesLoaded",
    Self::ChangesLoadFailed { .. } => "PrChangesLoadFailed",
    Self::ChangesBlobLoaded { .. } => "PrChangesBlobLoaded",
    Self::ChangesBlobLoadFailed { .. } => "PrChangesBlobLoadFailed",
