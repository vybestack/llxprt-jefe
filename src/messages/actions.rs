...
impl ActionsMessage {
    ...
    pub const fn name(&self) -> &'static str {
        match self {
            ...
            Self::CycleActionsSortByNext => "ActionsCycleActionsSortByNext",
            Self::CycleActionsSortByPrev => "ActionsCycleActionsSortByPrev",
            Self::ToggleActionsSortOrder => "ActionsToggleActionsSortOrder",
