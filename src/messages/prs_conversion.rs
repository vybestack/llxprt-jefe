...
impl PullRequestsMessage {
    ...
    fn from_app_event_controls(event: AppEvent) -> Self {
        ...
        match event {
            ...
            AppEvent::CyclePrSortByNext => Self::CyclePrSortByNext,
            AppEvent::CyclePrSortByPrev => Self::CyclePrSortByPrev,
            AppEvent::TogglePrSortOrder => Self::TogglePrSortOrder,
    ...
    fn into_app_event_controls(self) -> AppEvent {
        ...
        match message {
            ...
            Self::CyclePrSortByNext => AppEvent::CyclePrSortByNext,
            Self::CyclePrSortByPrev => AppEvent::CyclePrSortByPrev,
            Self::TogglePrSortOrder => AppEvent::TogglePrSortOrder,
