...
impl ActionsMessage {
    pub(super) fn from_app_event(event: AppEvent) -> Self {
        match event {
            ...
            AppEvent::CycleActionsSortByNext => Self::CycleActionsSortByNext,
            AppEvent::CycleActionsSortByPrev => Self::CycleActionsSortByPrev,
            AppEvent::ToggleActionsSortOrder => Self::ToggleActionsSortOrder,
